...
def run_ml_model(X, y):
    ...
    #rfc = RandomForestClassifier(n_estimators=50,bootstrap=True, random_state=1, max_depth=10, max_features="sqrt") # Recall = 0.5482
    rfc = RandomForestClassifier(n_estimators=1000,bootstrap=True, random_state=1, max_depth=500, max_features="sqrt")
